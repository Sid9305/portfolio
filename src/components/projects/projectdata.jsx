const projectData = [
  {
    ...
    description:
      "Developed an application which is able to crop/rotate/trim/compress a video and able to export them into local storage.",
    url: "https://github.com/Sid9305/x-pro_editor",
    backgroundColor: "#46aab3",
  },
  {
    title: "Emergency SOS Tracker",
